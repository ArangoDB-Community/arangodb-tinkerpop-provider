...
import com.arangodb.tinkerpop.gremlin.client.ArangoDBQuery.Direction;
...
public class SimpleVertexNeighborsTest extends BaseTestCase {
	...
	public void test_getVertexNeighbors() throws ArangoDBException {
		ArangoDBQuery query = client.getVertexNeighbors(graph, vertex2, null, null, null, null, false);
	...
	public void test_getVertexNeighborsWithCount() throws ArangoDBException {
		ArangoDBQuery query = client.getVertexNeighbors(graph, vertex2, null, null, null, null, true);
		Assert.assertNotNull(query);
	...
	public void test_getVertexOutNeighbors() throws ArangoDBException {
		ArangoDBQuery query = client.getVertexNeighbors(graph, vertex2, null, null, Direction.OUT, null, false);
		Assert.assertNotNull(query);
	...
	public void test_getVertexInNeighbors() throws ArangoDBException {
		ArangoDBQuery query = client.getVertexNeighbors(graph, vertex2, null, null, Direction.IN, null, false);
		Assert.assertNotNull(query);
