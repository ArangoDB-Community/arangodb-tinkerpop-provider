package com.arangodb.tinkerpop.gremlin.custom.process.traversal.step;
...
public abstract class OrderabilityTest extends AbstractGremlinProcessTest {
    ...
    public void g_inject_order() {
        ...
        checkOrderedResults(Arrays.asList(
                ...
                false, true,
                1, 2.0,
                OrderabilityTest.Constants.date,
                "bar", "foo",
                OrderabilityTest.Constants.uuid,
                OrderabilityTest.Constants.set1, OrderabilityTest.Constants.set2,
                OrderabilityTest.Constants.list1, OrderabilityTest.Constants.list2,
                OrderabilityTest.Constants.map1, OrderabilityTest.Constants.map2
        ), traversal);
    }
    ...
    public void g_inject_order_with_unknown_type() {
        ...
        final Object[] unordered = new Object[OrderabilityTest.Constants.unordered.length+1];
        unordered[0] = unknown;
        System.arraycopy(OrderabilityTest.Constants.unordered, 0, unordered, 1, OrderabilityTest.Constants.unordered.length);
    ...
    public static class Traversals extends OrderabilityTest implements OrderabilityTest.Constants {
